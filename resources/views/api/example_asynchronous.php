...
try{
	...
	$additionalHeaders = array($clConst['SANDBOX_MODE_HEADER'], // Sandbox mode - Scan without consuming any credits and get back dummy results
                                $clConst['HTTP_CALLBACK'].': https://7ba0cb113f7f6186ff34d58205eb6ff5.m.pipedream.net'
								# For a fast testing of callbacks option we recommend to use http://requestb.in
